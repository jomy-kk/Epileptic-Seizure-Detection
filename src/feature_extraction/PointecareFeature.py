...
class PointecareFeaturesCalculator(HRVFeaturesCalculator):
    ...
    def get_sd1(self):
        ...
        return FeatureSequence(self.sd1, 'SD1')
    ...
    def get_sd2(self):
        ...
        return FeatureSequence(self.sd1, 'SD2')

    def get_csi(self):
        return FeatureSequence(float(self.get_sd2()) / float(self.get_sd1()), 'CSI (SD2/SD1)')

    def get_csv(self):
        if not hasattr(self, 'csv'):
            self.csv = math.log10(self.get_sd1() * self.get_sd2())
        return FeatureSequence(self.csv, 'CSV')
